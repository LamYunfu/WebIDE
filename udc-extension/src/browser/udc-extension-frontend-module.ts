...
import { WebSocketConnectionProvider, createTreeContainer,
     TreeProps, defaultTreeProps,
       bindViewContribution, FrontendApplicationContribution, WidgetFactory, TreeDecoratorService } from '@theia/core/lib/browser';
...
// import { IssueViewWidgetFactory,IssueViewWidget} from './issue-view-widget';
// import { IssueViewContribution } from './issue-view-contribution';
...
export default new ContainerModule((bind: interfaces.Bind) => {
    ...
    // bind(IssueViewWidgetFactory).toFactory(ctx=>()=>createViewWeiget(ctx.container));
