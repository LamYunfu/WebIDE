            ...
            async (...args: any[]) => {
                ...
                const panel = theia.window.createWebviewPanel(
                    ...
                    // theia.ViewColumn.Active,
                    {
                        ...
                        viewColumn: theia.ViewColumn.Beside
                    },
                    {
                ...
                panel.webview.onDidReceiveMessage((e) => {
                    ...
                    } else if (e.command == "localSubmit") {
                        //e.text是需要打开的文件名 cam1/cam2/cam3/cam4/scanner
                        theia.commands.executeCommand("udc.menu.local_burn", e.text)
                    }
                    else if (e.command == "setPort") {
                        theia.commands.executeCommand("setPort", e.text)
                    } else if (e.command == "burn_cmd") {
                        theia.commands.executeCommand("udc.menu.local_compile_burn", e.text)
                    }
